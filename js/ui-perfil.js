...
let weeklyUpdateExpanded = false;
let goalsConfigExpanded = false;
...
export function renderPesos(){
  ...
  return `
    ...
    <section class="card">
      <button class="collapsible-header" id="weeklyToggleBtn" type="button">
        <span class="collapsible-title"><i data-lucide="line-chart"></i>Atualização semanal de peso</span>
        <i data-lucide="chevron-down" class="collapsible-chevron${weeklyUpdateExpanded?' open':''}"></i>
      </button>
      <div class="collapsible-body${weeklyUpdateExpanded?' open':''}">
    ...
    <section class="card">
      <button class="collapsible-header" id="goalsToggleBtn" type="button">
        <span class="collapsible-title"><i data-lucide="sliders-horizontal"></i>Configuração de metas</span>
        <i data-lucide="chevron-down" class="collapsible-chevron${goalsConfigExpanded?' open':''}"></i>
      </button>
      <div class="collapsible-body${goalsConfigExpanded?' open':''}">
        <div class="form-grid">
...
export function wirePesos(){
  ...
  document.getElementById('weeklyToggleBtn').addEventListener('click', ()=>{
    weeklyUpdateExpanded = !weeklyUpdateExpanded;
    const section = document.getElementById('weeklyToggleBtn').parentElement;
    section.querySelector('.collapsible-body').classList.toggle('open', weeklyUpdateExpanded);
    section.querySelector('.collapsible-chevron').classList.toggle('open', weeklyUpdateExpanded);
  });
  document.getElementById('goalsToggleBtn').addEventListener('click', ()=>{
    goalsConfigExpanded = !goalsConfigExpanded;
    const section = document.getElementById('goalsToggleBtn').parentElement;
    section.querySelector('.collapsible-body').classList.toggle('open', goalsConfigExpanded);
    section.querySelector('.collapsible-chevron').classList.toggle('open', goalsConfigExpanded);
  });

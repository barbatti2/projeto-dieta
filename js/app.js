...
import { loadProfile, store, syncFromCloud } from './state.js';
...
document.querySelector('.navbar-row').addEventListener('click', (e)=>{
...
export async function startApp(){
  ...
  setupDateStripDrag();
  icons();
  document.getElementById('syncNowIconBtn').addEventListener('click', async (e)=>{
